...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 08, 2024 lúc 05:34 AM
...
(1, 1, 'ok', '2023-11-30 11:33:01'),
(99, 14, 'hjsacbhjbchj', '2023-11-29 11:33:01');
...
(99, 'abc', 'Hà Nội', '888', 'fanexo@gmail.com');
...
(1, 'Thế Anh', 'Bắc Giang', 1223456789, 'abc@gmail.com', '111111'),
(2, 'Anh', 'Hà Nội', 89999999, '123@gmail.com', '111111'),
(11, 'Hiếu', 'Hà Nam', 123, 'hieu@gmail.com', '123'),
(17, 'abc', '', 0, '123@gmail.com', '111111');
...
(3, 20, '2023-12-16 06:53:41'),
(4, 15, '2023-12-10 11:53:41');
...
(2, 'Anh', 'a@gmail.com', 'Hí hí', 'demo', '2023-11-28 16:48:16', 1);
...
INSERT INTO `nguoidung` (`manguoidung`, `tennguoidung`, `emailnguoidung`, `matkhau`, `role`) VALUES
(1, 'The Anh', '123@gmail.com', 9999, 1),
(3, 'Nguyễn Thế Anh', 'anhnxtph33000@gmail.com', 9999, 1);
...
(1, 'Thế Anh', 'Bắc Giang', 88889999),
(2, 'Anh', 'Bắc Giang', 99998888),
(3, 'Nguyễn Thế Anh', 'Bắc Giang', 77778888),
(4, 'Vẫn Là Thế Anh', 'Bắc Giang', 66667777);
...
(4, 'Lựu đỏ', 7, 0, 2000, 'product-home-1-img-3.jpg', 'Lựu có tên khoa học là Punica granatum L. (Punicaceae), là loại cây thân gỗ lá rụng có nguồn gốc từ Iran và các nước dọc theo duyên hải Địa Trung Hải. Nay được trồng nhiều tại các vùng nhiệt đới và ôn đới, trong đó có Việt Nam. Quả mọng hình cầu, màu đỏ vàng, có vị ngọt tự nhiên, dồi dào vitamin C, A, E và khoáng chất, rất tốt cho sức khỏe và làn da. Thông thường lựu đỏ được ép lấy nước để uống giải khát hoặc được thêm vào các thành phần kem dưỡng da. Gần đây cách làm trắng da tại nhà bằng lựu đỏ khá được ưa chuộng.', 3, 4),
...
(9, 'Cam Xoàn Miền tây', 7, 15, 7000, 'product-home-1-img-7.jpg', 'Thuộc loại trái cây vùng nhiệt đới, cam xoàn cùng họ với cam mật nhưng vẫn có điểm khác với cam mật. Trong danh sách các loại cam ngon nhất Việt Nam, bao giờ cũng không thể không nhắc tới cam xoàn. \r\n\r\nTùy thuộc vào thổ nhưỡng khác nhau mà các loại cam ở từng nơi sẽ có vị khác nhau. Cam xoàn đến từ vùng đất Miền Tây, có vị ngọt đậm rất dễ ăn. Cây cam xoàn khi trồng rất sai quả và còn cho trái quanh năm. ', 3, 4),
...
(12, 'Lê Hàn Quốc', 7, 999, 8000, 'le-han-quoc.jpg', 'Quả lê tính lạnh, bình hòa không độc hại, rất giàu vitamin C và pectin là chất giúp làm tăng độ xốp và men vi sinh giúp hệ tiêu hóa ổn định, nhu động ruột thải bã dễ dàng.\r\nVỏ quả lê có giá trị chữa bệnh cao, có lợi cho tim và phổi, giúp tiêu độc hạ nhiệt. Lê chứa vitamin A, B, C, D và E. Một trái lê có thể cung cấp 10% hàm lượng vitamin C và hàm lượng canxi khá lớn.\r\n\r\n', 3, 2),
...
(1, 'Anh', 'anh@gmail.com', 123, 'ahjbcj', '2023-11-30 20:48:08', 0);
